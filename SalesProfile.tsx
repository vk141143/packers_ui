...
import { User, Mail, Phone, MapPin, Calendar, Edit2, Save, X, Target, TrendingUp } from 'lucide-react';
...
const SalesProfile: React.FC<SalesProfileProps> = ({ user }) => {
        ...
        <div className="bg-gray-50 p-6 rounded-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                ...
                {isEditing ? (
                  ...
                  <p className="mt-1 text-gray-900">{formData.salesTarget}</p>
                )}
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                <label className="block text-sm font-medium text-gray-700">Sales Achieved</label>
                {isEditing ? (
                  <input
                    type="text"
                    name="salesAchieved"
                  ...
                  <p className="mt-1 text-gray-900">{formData.salesAchieved}</p>
                )}
              </div>
            </div>
          </div>
